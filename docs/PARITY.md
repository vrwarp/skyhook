...
64 gaps: 13 open, 11 by-design, 39 fixed, 1 disproven.
...
| P-140 | open | A widget that claimed one axis is not claimed at all: touch-action pan-x/pan-y goes unread | widgets/swipe-carousel |
