...
| P-111 | open | mousemove-driven widgets — drag-and-drop, sliders, hover menus — have no input path | touch/drag-pan, widgets/dnd-html5, widgets/drag-sortable, widgets/hover-menu, widgets/slider-track |
